"use strict";
/* build-hook-start *//*00001*/try { require('c:\\Users\\Alejandro.SGVAD\\.vscode\\extensions\\wallabyjs.console-ninja-1.0.376\\out\\buildHook\\index.js').default({tool: 'nest.js', checkSum: '20a02244aab51255495d0eWB4HHAQOUFFbVlcABVABWAIHVARU', mode: 'runtime'}); } catch(cjsError) { try { import('file:///c:/Users/Alejandro.SGVAD/.vscode/extensions/wallabyjs.console-ninja-1.0.376/out/buildHook/index.js').then(m => m.default.default({tool: 'nest.js', checkSum: '20a02244aab51255495d0eWB4HHAQOUFFbVlcABVABWAIHVARU', mode: 'runtime'})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
