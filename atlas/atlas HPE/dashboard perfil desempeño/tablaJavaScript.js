...
function getDataIndicadores() {
    return $.ajax({
      dataType: "json",
      type: "GET",
      url: "http://localhost:8080/datos/indicadores/444" //Se corresponde a la url del widget. Le falta el id del documento en concreto el cual será el id del dashboard
    })
  }
...
function getDataTabla(indicador, sectores) {
    return $.ajax({
        dataType: 'json',
        type: 'GET',
        url: 'http://localhost:8080/datos/perfil/'+indicador.id,
...
function getLeyendaPerfilDesempenno(HTMLelement, values) {
    ...
    return $.ajax({
        type: 'GET',
        dataType: 'json',
        url: 'http://localhost:8080/datos/leyenda/' + idLeyenda
    }).then(function(data) {
